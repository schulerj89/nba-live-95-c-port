...
- Camera-subject/possession confusion, the false stale-AE explanation of the upper20/21 draw branch, and use of F34F where original draw/contact callers use F02D are port translation errors under separate correction. They are not original behavior to preserve or add to the defect count.
