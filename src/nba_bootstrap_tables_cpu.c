...
#include "nba_bootstrap_tables_cpu_program.inc"
...
bool nba_bootstrap_tables_cpu_power_on(NbaBootstrapCpu *s) {
...
bool nba_bootstrap_tables_cpu_peek(const NbaBootstrapCpu *s,NbaCodecBusCycle *out) {
...
bool nba_bootstrap_tables_cpu_accept(NbaBootstrapCpu *s,uint8_t value) {
