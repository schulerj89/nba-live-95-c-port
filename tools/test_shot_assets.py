...
from extract_assets import build_shot_gameplay_asset
...
def main():
    ...
    old=bytearray(raw)
    struct.pack_into('<I',old,12,count-1)
    keep=[e for e in entries if e[0]!=277]
    ...
    print('[SHOT ASSETS] 528-byte table payload equals ROM')
