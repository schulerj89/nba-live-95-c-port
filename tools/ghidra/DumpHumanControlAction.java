...
public class DumpHumanControlAction extends GhidraScript {
 public void run() throws Exception {
  int bank=Integer.parseInt(getScriptArgs()[1],16);
  int start=bank==0x84?0xdf7a:0xf347, end=bank==0x84?0xe2ab:0xf3ba;
  ...
  int[] seeds=bank==0x84?new int[]{0xdf7a,0xe03c,0xe0b5,0xe141,0xe231}:new int[]{0xf347,0xf34f};
  for(int seed:seeds)disassemble(toAddr(seed));
  try(PrintWriter out=new PrintWriter(new File(getScriptArgs()[0],String.format("control_action_bank%02x.txt",bank)),"UTF-8")){
