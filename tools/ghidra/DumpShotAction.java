...
public class DumpShotAction extends GhidraScript {
    public void run() throws Exception {
        ...
        long[][] ranges=facing ? new long[][]{{0xf02d,0xf099}} :
            new long[][]{{0x9846,0x99c3},{0xb625,0xb978}};
        for(long[] r:ranges) {
        ...
        long[] pcs=facing ? new long[]{0xf02d} : new long[]{0x9846,0x9861,0x986d,0xb625,0xb6d3,0xb769,0xb7cd,0xb84c,0xb867,0xb890,0xb8c0,0xb8ca};
        String[] names=facing ? new String[]{"QuantizeShotFacing"} : new String[]{"RestoreActionMode","ClearActionFlags","RimHangAfterFinish","InitializeShot","StandardShotActionStart","ExecuteShot","ShotWindupTimer","ShotJumpLowerInstall","ShotOwnerLost","CancelPumpFake","ShotReleaseCleanup","ShotFacingAndRelease"};
