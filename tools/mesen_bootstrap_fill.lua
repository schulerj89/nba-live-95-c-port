...
local function finish()
 ...
 local f=assert(io.open(out..'/complete.txt','wb'));f:write('ok; normal power-on through first reset fill return80C0\n');f:close();emu.stop(0)
end
emu.addMemoryCallback(function(pc)
 ...
 if pc==0x8080c0 then snapshot('cpu_fill_return');finish();return end
 if pc==0x808a8d then
