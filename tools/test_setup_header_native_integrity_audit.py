...
def main():
    ...
    spec = importlib.util.spec_from_file_location('header_native_audit', a.verifier)
    ...
    cases = [('dma_pair_before_scope', 'header_work_bus.jsonl', dma_backward),
             ('cpu_write_before_scope', 'header_work_bus.jsonl', write_backward),
             ('dma_wrong_source_pc', 'header_work_bus.jsonl', dma_pc),
             ('native_instruction_clock_reversal', 'header_work_instructions.jsonl', reorder_instructions),
             ('native_mixed_bus_clock_reversal', 'header_work_bus.jsonl', reorder_bus)]
    results = []
