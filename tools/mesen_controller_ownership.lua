...
emu.addEventCallback(function()
    ...
    if court>=0 then
        ...
        if court==0 or court==30 or court==45 or court==90 or court==140 or court==185 or court==320 then rgb('court_'..court)end
        if court==30 or court==45 then dump_wram('court_'..court)end
        court=court+1
