...
def main():
 ...
 spec=importlib.util.spec_from_file_location('bootstrap_verify',Path(__file__).with_name('verify_bootstrap_v2.py'));v=importlib.util.module_from_spec(spec);spec.loader.exec_module(v)
