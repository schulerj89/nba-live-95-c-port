...
local function finish()
 ...
 local f=assert(io.open(out..'/complete.txt','wb'));f:write('ok; normal power-on through pre-NMI-enable8145\n');f:close();emu.stop(0)
end
emu.addMemoryCallback(function(pc)
 ...
 if pc==0x808145 then snapshot('cpu_nmi_enable');finish();return end
 if pc==0x808a8d then
