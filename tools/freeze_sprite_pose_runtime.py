...
FILES=['.gitattributes','include/nba_assets.h','include/nba_player_lab.h','src/nba_assets.c','src/nba_player_lab.c','src/nba_tipoff.c','tools/extract_assets.py','docs/sprite-pose-compositor-component.md','docs/sprite-pose-runtime-adapter.md','tools/build_player_draw_inputs.py','tools/build_sprite_pose_guards.py','tools/build_sprite_pose_probe.py','tools/build_sprite_pose_runtime_probe.py','tools/freeze_sprite_pose_runtime.py','tools/inspect_sprite_pose_source.py','tools/sprite_pose_guard_probe.c','tools/sprite_pose_probe.c','tools/sprite_pose_rom_oracle.py','tools/sprite_pose_runtime_probe.c','tools/test_sprite_pose.py','tools/test_sprite_pose_protocol.py','tools/test_sprite_pose_runtime_inputs.py','tools/test_sprite_pose_runtime_source.py','tools/upgrade_player_draw_pack.py','tools/verify_sprite_pose_live_runtime.py','tools/verify_sprite_pose_runtime.py']
