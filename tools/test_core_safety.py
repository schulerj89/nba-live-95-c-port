...
def check_asset_loader(exe, directory):
    ...
    invalid_packs = {
        ...
        "short_license.pak": b"NBA95PAK" + struct.pack("<II", 1, 1) +
            pack_entry(1, 40, 1, 128, 11) + b"\0",
        "short_legal.pak": b"NBA95PAK" + struct.pack("<II", 1, 1) +
            pack_entry(2, 40, 1, 256, 151, 35) + b"\0",
        "short_ea_pixels.pak": b"NBA95PAK" + struct.pack("<II", 1, 1) +
            pack_entry(3, 40, 1, 1, 1) + b"\0",
        "oversized_ea_dimensions.pak": b"NBA95PAK" + struct.pack("<II", 1, 1) +
            pack_entry(3, 40, 1, 0xFFFFFFFF, 0xFFFFFFFF) + b"\0",
        "offscreen_ea_flags.pak": b"NBA95PAK" + struct.pack("<II", 1, 1) +
