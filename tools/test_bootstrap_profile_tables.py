...
def main():
    ...
    spec=importlib.util.spec_from_file_location('bootstrap_verify_v2',Path(__file__).with_name('verify_bootstrap_tables.py'))
    ...
    for case in cases:
        ...
        def rows(path):
            ...
            elif case=='SPC_final_end':q['end']=not q['end']
