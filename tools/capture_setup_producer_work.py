"""Natural residual producer source-work capture; read-only instructions, writes and call boundaries."""
import argparse
import hashlib
import json
import os
...
def main():
 ...
 script=out/'capture.lua';shutil.copyfile(Path(__file__).with_name('mesen_setup_producer_work.lua'),script)
 ...
 for name,path in [('rom',rom),('mesen',exe),('script',script),('runner',runner),('settings',initial),('base_script',base),('codec_script',codec)]:
