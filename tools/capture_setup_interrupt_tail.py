...
def main():
 ...
 script=out/'capture.lua';shutil.copyfile(Path(__file__).with_name('mesen_setup_interrupt_tail.lua'),script)
 ...
 for name,path in [('rom',rom),('mesen',exe),('script',script),('runner',runner),('settings',initial),('base_script',base)]:
