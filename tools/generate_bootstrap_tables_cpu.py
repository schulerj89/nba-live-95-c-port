...
def scope(pc):return 0x800d<=pc<0x8145 or 0x8a57<=pc<=0x8a92 or 0xab06<=pc<=0xac1a or 0xac89<=pc<=0xacc1 or 0xda72<=pc<=0xda90
...
def generate(rom,d):
    ...
    out=['/* Generated canonical reset/upload/first-fill/reset-tables source. No opcode dispatch. */',
