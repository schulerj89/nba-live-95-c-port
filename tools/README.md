...
| `mesen_gameplay_player_capture.lua` | Drives into gameplay, records raw PPU state and executed player-loader paths, and traces roster/appearance/palette reads used to prove the F9 Player Lab ROM extraction |
