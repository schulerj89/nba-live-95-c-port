"""Natural codec source-work capture; read-only instructions, writes and call boundaries."""
import argparse
import hashlib
import json
import os
...
def main():
 ...
 script=out/'capture.lua';shutil.copyfile(Path(__file__).with_name('mesen_setup_codec_work.lua'),script)
