...
def validate(trace,summary,rom,decoder):
    ...
    projection_pcs={0x8080bc,0x8080c0,0x8080ca,0x8080fd,0x808101,0x808141,0x808145,0x809b73,0x809bed,0x809bef,0x80aacd,0x8156}
    ...
    control_states[0x808184]=clock.projection()
