"""Replay `$85:B402-$B4B8` arrival/velocity calls through compiled C."""
...
def main():
    ...
    for vector in vectors:
        ...
        # `$85:A82C` reuses DP $AA as a velocity scratch word after B402
        # preserves the steering result in DP $B6.
    ...
    print(f"[PREDICTIVE ARRIVAL STEP] "
