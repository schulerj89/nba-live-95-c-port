...
cl /nologo /W4 /WX /O2 /MD /utf-8 /I "$root\include" /Fe"$output\period_restart_probe.exe" /Fo"$output\\" "$root\tools\period_restart_probe.c" "$root\src\nba_period_restart.c"
exit /b %ERRORLEVEL%
"@
...
$files = @('include/nba_period_restart.h','src/nba_period_restart.c','tools/period_restart_probe.c','tools/period_restart_probe_fields.inc','tools/build_period_restart_probe.ps1')
