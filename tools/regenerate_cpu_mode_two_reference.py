"""Generate fresh Ghidra and snesrecomp references for CPU mode two."""
...
FIRST = 0xF6CD
END = 0xF794
REQUIRED = (0xF6CD, 0xF6D0, 0xF6D2, 0xF6D7, 0xF6DB, 0xF6DD,
            0xF6EF, 0xF721, 0xF72E, 0xF750, 0xF780, 0xF78B, 0xF793)
...
def main():
    ...
    script = Path(__file__).with_name("ghidra") / "DumpCpuModeTwo.java"
    ...
    generated = emit_bank(rom, bank, [
        BankEntry("CpuModeTwo", FIRST, END, 0, 0)
    ])
    (out / "cpu_mode_two_bank86.c").write_text(
    ...
    project = out / "project"
    project.mkdir()
    command = [str(args.ghidra), str(project), "CpuModeTwo", "-import",
    ...
    listing = out / "cpu_mode_two_bank86.txt"
    ...
    print("bank 86: fresh Ghidra and recomp CPU mode-two references")
